...
'components' => [
    'view' => [
        'theme' => [
            'pathMap' => [
                '@ddmtechdev/user/views' => '@app/views/user'
            ],
        ],
    ],
],
...
In the above `pathMap` means that every view in @ddmtechdev/user/views will be first searched under `@app/views/user` and
