 ...
 */
return [
    'Account activated by administrator on {0}' => 'Kontoaktivierung durch Administrator auf {0}',
    'Activate' => 'Aktivieren',
    'An Administrator needs to activate your account. You\'ll receive an email when your account has been activated' =>
    'Ein Administrator muss Ihr Konto aktivieren. Sie erhalten eine E-Mail wenn ihr Konto aktiviert wurde',
    'Are you sure you want to activate this user?' => 'Sind Sie sicher, dass Sie den Benutzer aktivieren möchten?',
    'In order to finish your registration, we need you to enter following fields' => '',
    'Not yet activated by admin' => 'Noch nicht durch Administrator aktiviert',
    ...
    'Your account has not yet been activated by an administrator' => 'Ihr Konto wurde noch nicht von einem Administrator aktiviert',
    'Your account on {0} has been activated by an administrator' => 'Ihr Konto auf {0} wurde von einem Administrator aktiviert',
