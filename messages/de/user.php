...
return [
    ...
    'Awesome! You have successfully confirmed your email address. You may sign in using your credentials now.' => '@@Perfekt! Sie haben Ihre E-Mail erfolgreich bestätigt, Sie können sich jetzt mit Ihren Zugangsdaten anmelden.@@',
    'Before your email will be changed we need you to confirm your new email address' => '@@Bevor wir Ihre E-Mail ändern, muss die neue durch Sie bestätigt werden@@',
    ...
    'Cancel email change' => '@@E-Mail Änderung abbrechen@@',
    ...
    'Confirm your email change on {0}' => '@@Bestätigen Sie die Änderung Ihrer E-Mail-Adresse hier {0}@@',
    'Confirmation needed' => '@@Bestätigung benötigt@@',
    'Confirmation token is invalid' => '@@Bestätigungsschlüssel nicht korrekt@@',
    'Connect this account by entering desired username and your email address below' => '@@Verbinden Sie diesen Zugang indem Sie Ihren gewünschten Benutzernamen und Ihre E-Mail unten eintragen@@',
    ...
    'Email change has been cancelled' => '@@Änderung der E-Mail-Adresse abgebrochen@@',
    ...
    'Password and username will be sent to user by email' => '@@Das Passwort wird dem User via E-Mail gesendet.@@',
    ...
    'The email can take a few minutes to arrive' => '@@Die E-Mail kann einige Minuten benötigen@@',
    ...
    'We need to confirm your email address' => '@@Perfekt, fast fertig! Sie müssen jetzt noch Ihre E-Mail bestätigen.@@',
