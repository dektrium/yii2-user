...
return [
    ...
    'Complete password reset on {0}' => 'Mot de passe réinitialiser complète sur {0}',
    ...
    'The confirmation link is invalid or expired. Please try requesting a new one.' => 'Le lien de confirmation est invalide ou expiré. Veuillez essayer de nouveau.',
    ...
    'Credentials will be sent to the user by email' => 'Les pouvoirs seront envoyés à l\'utilisateur par e-mail',
    'A password will be generated automatically if not provided' => 'Un mot de passe sera généré automatiquement si non prévu',
    ...
    'Recovery link is invalid or expired. Please try requesting a new one.' => 'Le lien de récupération est valide ou expiré. Veuillez essayer à nouveau.',
    'Something went wrong and your account has not been confirmed.' => 'Quelque chose s\'est mal déroulé et que votre compte n\'a pas été confirmée.',
    ...
    'Your confirmation token is invalid or expired' => 'Votre jeton de confirmation est invalide ou expiré',
