...
return [
    ...
    'Awesome! You have successfully confirmed your email address. You may sign in using your credentials now.' => '@@Félicitations ! Vous avez confirmé votre e-mail. Vous pouvez vous connecter en utilisant vos identifiants maintenant.@@',
    ...
    'Complete your password reset on {0}' => '@@Complétez la réinitialisation de votre mot de passe pour {0}@@',
    ...
    'Delete recovery tokens' => '@@Supprimer les jetons de récupération@@',
    'Email change has been cancelled' => '@@Le changement d\'e-mail a été annulé@@',
    'Email settings' => '@@Paramètres e-mail@@',
    'In order to complete your request, we need you to verify that you initiated this request' => '@@Afin de compléter votre demande, nous devons vérifier que vous avez bien initié la requête@@',
    'Last login at {0, date, MMMM dd, YYYY HH:mm} from {1}' => '@@Dernière connexion le {0, date, d MMMM YYYY à HH:mm} de {1}@@',
    ...
    'Registered at {0, date, MMMM dd, YYYY HH:mm} from {1}' => '@@Enregistré le {0, date, d MMMM YYYY à HH:mm} de {1}@@',
    ...
    'This URL will only be valid for a limited time and will expire' => '@@Ce lien ne sera valable que pour une durée limitée et expirera au delà@@',
    ...
    'You have been sent an email with instructions on how to reset your password.' => '@@Nous vous avons envoyé un e-mail avec les instructions de réinitialisation de votre mot de passe.@@',
    'You have successfully cancelled email changing process' => '@@Vous avez annulé avec succès la procédure de changement d\'e-mail@@',
