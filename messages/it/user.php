...
return [
    ...
    'Connect this account by entering desired username and your email address below' => '@@Collega questo account inserendo username e il tuo indirizzo email qui sotto@@',
    'Connect your account to {0}' => '@@Connetti il tuo account a {0}@@',
    ...
    'This URL will only be valid for a limited time and will expire' => '@@Il seguente URL sar&agrave; valido per un periodo di tempo limitato dopodich&egrave; scadr&agrave;@@',
    'Update user profile' => '@@Aggiorna profilo utente@@',
    'User has been updated' => '@@L\'utente &egrave; stato aggiornato@@',
    'You have successfully cancelled email changing process' => '@@Annullamento della procedura di cambio password eseguito@@',
    'You will never have to use this form again' => '@@Non dovrai mai pi&ugrave; utilizzare questo modulo in futuro@@',
    ...
    'Already registered? Sign in!' => 'Gi&agrave; registrato? Entra!',
