...
return [
    ...
    'Your email address has been changed' => 'O seu endereço de e-mail foi alterado com sucesso',
    ...
    'If you did not make this request you can ignore this email' => 'OBS: Caso você não tenha solicitado a redefinição da sua senha, por favor ignore esta mensagem. A sua conta está segura.',
    'If you did not make this request you can ignore this email' => 'OBS: Caso você tenha recebido este email por engano, simplesmente apague-o',
    'Password' => 'Senha',
    ...
    'We have received a request to change the email address for your account on {0}' => 'Você solicitou recentemente uma troca de e-mail no site {0}',
    'We have received a request to reset the password for your account on {0}' => 'Você solicitou recentemente uma redefinição da sua senha no site {0}',
