...
return [
    'Actions' => 'Действия',
    'Approve' => 'Одобрить',
    'Approve status' => 'Статус',
    'Are you sure you want to approve this user?' => 'Вы уверены, что хотите одобрить этот аккаунт',
    'Are you sure you want to confirm email of this user?' => 'Вы уверены, что хотите подтвердить Email этого пользователя',
    'Confirm email' => 'Подтвердить Email',
    'Confirm status' => 'Статус Email',
    'Confirmation message has been resent to your email address' => 'Письмо со ссылкой для подтверждения было отправлено на ваш Email',
    'Email is not confirmed' => 'Email не подтверждён',
    'Filter' => 'Отфильтровать',
    'Reset filter' => 'Сбросить',
    'Show all' => 'Показать все',
    'Show approved' => 'Показать одобренных',
    'Show blocked' => 'Показать заблокированных',
    'Show confirmed' => 'Показать подтвержденных',
    'Show not approved' => 'Показать неодобренных',
    'Show not blocked' => 'Показать незаблокированных',
    'Show not confirmed' => 'Показать неподтверждённых',
    'The requested page does not exist' => 'Страница не найдена',
    'User has been approved' => 'Аккаунт пользователя был одобрен',
    'User is blocked' => 'Пользователь заблокирован',
    'User is not approved' => 'Пользователь не одобрен',
    'Your account needs to be approved by administrator' => 'Ваш аккаунт должен быть одобрен админиистрацией',
    'Your account on {0} has been approved' => 'Ваш аккаунт на сайте {0} был одобрен',
