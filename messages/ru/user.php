...
return array (
  ...
  'Please save your two-factor recovery codes from {0}' => 'Пожалуйста, сохраните ваши двухфакторные коды восстановления от {0}',
  'You have enabled two-factor authentication' => 'Вы включили двухфакторную авторизаци',
  'Please save recovery codes' => 'Пожалуйста сохраните коды восстановления',
  'Recovery codes are the only way to access your account again. By saving your recovery codes, you’ll be able to regain access if you:' => 'Коды восстановления - это единственный способ снова получить доступ к вашей учетной записи. Сохраняя коды восстановления, вы сможете восстановить доступ, если вы:',
  'Lose your phone' => 'Потеряли свой телефон',
  'Delete your authenticator application' => 'Удалить ваше приложение для проверки подлинности',
