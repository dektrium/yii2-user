...
return [
    ...
    'You can now log in with the following credentials:' => 'Ви вже можете авторизуватися з наступними реквизитами:',
    ...
    'Confirmation token is invalid' => 'Посилання для активації аккаунта невірне',
    ...
    'Delete recovery tokens' => 'Видалити токени відновлення',
    'Email change has been cancelled' => 'Зміну email було скасовано',
    ...
    'Last login at {0, date, MMMM dd, YYYY HH:mm} from {1}' => 'Останняя авторизація {0, date, MMMM dd, YYYY HH:mm} з {1}',
    'Looks like this is first time you are using {0} account to sign in to {1}' => 'Схоже, що ви вперше використовуєте {1}, щоб зайти на {0}',
    'Password and username will be sent to user by email' => 'Пароль та ім\'я користувача будуть вислані користувачу на email',
    'Password recovery finished' => 'Процедуру скидання пароля завершено',
    'Password settings' => 'Налаштування пароля',
    'Please check your email and click the confirmation link to complete your registration' => 'Будь-ласка, провірте вашу поштову скриньку і натисніть посилання в листі, щоб завершити реєстрацію',
    'Please check your email and click the reset link.' => 'Будь-ласка, провірте вашу поштову скриньку і натисніть посилання в листі, щоб відновити пароль.',
    'Profile updated successfully' => 'Профіль було змінено',
    'Recovery message has been sent' => 'Листа з посиланням для зміни паролю було відправлено',
    'Recovery token is invalid' => 'Посилання для зміни паролю недійсне',
    ...
    'User has been updated' => 'Дані користувача було змінено',
