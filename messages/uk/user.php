...
return array (
  ...
  'If you want password to be generated automatically leave its field empty' => 'Якщо ви хочете, щоб пароль було згенеровано автоматично, залишіть поле пустим',
  ...
  'P.S. If you did not request to reset your password, please disregard this message. Your account is safe' => 'P.S. Якщо ви не починали цей запит, проігноруйте це повідомлення. Ваш аккаунт в безпеці',
  'P.S. If you received this email by mistake, simply delete it' => 'P.S. Якщо ви отримали це повідомлення про помилку, просто видаліть його',
  ...
  'You have recently requested email change on {0}' => 'Ви нещодавно запросили зміну email на {0}',
  'You have recently requested to reset your password on {0}' => 'Ви нещодавно запросили зміну пароля на {0}',
  ...
  'Are you sure to block this user?' => 'Ви впевнені, що хочете заблокувати користувача?',
  'Are you sure to confirm this user?' => 'Ви впевнені, що хочете підтвердити аккаунт користувача?',
  'Are you sure to unblock this user?' => 'Ви впевнені, що хочете розблокувати користувача?',
  ...
  'Registered at {0} from {1}' => 'Зареєстровано {0} з {1}',
  ...
  'Users' => 'Користувачі',
  'We are sorry but your confirmation token is invalid. Maybe it is out-of-date or does not exist. You can try requesting a new one by clicking the link below:' => 'Нажаль ваше посилання для активації аккаунта недійсне. Можливо закінчився термін його дії або вона взагалі не існує. Ви можете запросити нове, натиснувши на посилання нижче:',
  'We are sorry but your confirmation token is invalid. Maybe it is out-of-date or does not exist. You can try requesting new recovery token.' => 'Нажаль ваше посилання для скидання пароля недійсне. Можливо закінчився термін його дії або вона взагалі не існує. Ви можете спробувати запросити нову.',
  'Website' => 'Вебсайт',
