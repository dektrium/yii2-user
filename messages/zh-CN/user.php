...
return [
    ...
    'A confirmation message has been sent to your new email address' => '确认消息已发送到您的新电子邮件地址',
    ...
    'A message has been sent to your email address. It contains your password and a confirmation link that you must click to complete registration.' => '邮件已发送到您的电子邮件地址。 它包含您的密码和确认链接，您必须单击才能完成注册。',
    'A new confirmation link has been sent' => '已发送新的确认链接',
    'Account confirmation' => '账户确认',
    'Account details' => '帐户详情',
    'Account details have been updated' => '帐户详情已更新',
    'An email has been sent with instructions for resetting your password' => '我们发送了一封电子邮件，其中包含重置密码的说明',
    'An error occurred and your password has not been changed. Please try again later.' => '发生错误，您的密码未更改。 请稍后再试。',
    'An error occurred processing your request' => '处理您的请求时出错',
    'Assignments' => '',
    'Awesome, almost there. Now you need to click the confirmation link sent to your new email address' => '',
    'Awesome, almost there. Now you need to click the confirmation link sent to your old email address' => '',
    'Complete password reset on {0}' => '完成 {0} 密码重置',
    'Confirm account on {0}' => '确认 {0} 账号',
    'Confirm email change on {0}' => '确认 {0} 邮箱更改',
    'Confirmation status' => '确认状态',
    'Confirmation time' => '确认时间',
    'Create' => '创建',
    'Credentials will be sent to the user by email' => '密码将通过电子邮件发送给用户',
    'Delete' => '删除',
    'Don\'t have an account? Sign up!' => '没有帐号？ 立即注册！',
    ...
    'Profile details have been updated' => '资料详情已更新',
    'Recovery link is invalid or expired. Please try requesting a new one.' => '恢复链接无效或过期。 请尝试请求一个新的。',
    'Recovery message sent' => '',
    'Registration IP' => '注册 IP',
    'Roles' => '',
    'Something went wrong' => '',
    'Something went wrong and your account has not been confirmed.' => '',
    'Thank you, registration is now complete.' => '谢谢，现在注册已经完成。',
    'The confirmation link is invalid or expired. Please try requesting a new one.' => '确认链接无效或过期。 请尝试请求一个新的。',
    'Unconfirmed' => '',
    'Update' => '更新',
    'User is not found' => '',
    'VKontakte' => '',
    ...
    'You can connect multiple accounts to be able to log in using them' => '您可以连接多个帐户以使用它们登录',
    'You can not block your own account' => '',
    'You can not remove your own account' => '',
    'You can now log in with the following credentials:' => '',
    'Your account details have been updated' => '',
    'Your account has been connected' => '您的帐户已连接',
    ...
    'Invalid token' => '@@无效的令牌@@',
    'Last login at {0, date, MMMM dd, YYYY HH:mm} from {1}' => '@@最后登录于 {0, date, YYYY年MM月dd日 HH:mm} fra {1}@@',
    ...
    'Registered at {0, date, MMMM dd, YYYY HH:mm} from {1}' => '@@注册于 {0, date, YYYY年MM月dd日 HH:mm} 从 {1}@@',
