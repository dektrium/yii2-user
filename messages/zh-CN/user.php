...
return [
    ...
    'A message has been sent to your email address. It contains your password and a confirmation link that you must click to complete registration.' => '一条信息已经发送到您的邮箱，里面包含了密码和确认链接，您必须点击完成注册。',
    'A new confirmation link has been sent' => '新的确认链接已发送。',
    'Account confirmation' => '帐户确认',
    'Account details' => '帐户详情',
    'Account details have been updated' => '账户详情已更新',
    'An email has been sent with instructions for resetting your password' => '重设密码的邮件已发送',
    'An error occurred and your password has not been changed. Please try again later.' => '产生了一个错误，您的密码没有修改成功，请稍候再试。',
    'An error occurred processing your request' => '处理请求出错',
    'Assignments' => '分配',
    'Awesome, almost there. Now you need to click the confirmation link sent to your new email address' => '',
    'Awesome, almost there. Now you need to click the confirmation link sent to your old email address' => '',
    'Complete password reset on {0}' => '在 {0} 上重置密码',
    'Confirm account on {0}' => '确认 {0} 上的帐户',
    ...
    'Thank you, registration is now complete.' => '恭喜您，注册成功。',
    ...
    'You can now log in with the following credentials:' => '您现在可以用以下信息登录：',
    'Your account details have been updated' => '',
    'Your account has been connected' => '',
    'Your account on {0} has been created' => '你在 {0} 上的帐号已经被创建',
    ...
    'Don\'t have an account? Sign up!' => '还没有帐号，现在注册',
