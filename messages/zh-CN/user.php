...
return array (
    ...
    'Are you sure to block this user?' => '确定锁定该用户?',
    'Are you sure to confirm this user?' => '确认该用户?',
    'Are you sure to delete this user?' => '您确定要删除这个用户？',
    'Are you sure to unblock this user?' => '您确定要取消锁定该用户?',
    ...
    'Username' => '用户名',
    'Users' => '用户',
    'We are sorry but your confirmation token is invalid. Maybe it is out-of-date or does not exist. You can try requesting a new one by clicking the link below:' => '对不起，令牌是无效的。您可以尝试点击下面的链接生成新的:',
    'We are sorry but your confirmation token is invalid. Maybe it is out-of-date or does not exist. You can try requesting new recovery token.' => '对不起，令牌是无效的。您可以尝试请求新的:',
    'Website' => '网站',
    'Welcome to {0}' => '欢迎来到 {0}',
