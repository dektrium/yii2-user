...
class m150614_103145_update_social_account_table extends Migration
{
    public function up()
    {
        $this->addColumn('{{%social_account}}', 'code', $this->string(32));
        $this->addColumn('{{%social_account}}', 'created_at', $this->integer());
        $this->addColumn('{{%social_account}}', 'email', $this->string());
        $this->addColumn('{{%social_account}}', 'username', $this->string());
