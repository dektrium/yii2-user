...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
          ...
          'value' => function ($model) {
              return (!$model->last_login_at || $model->last_login_at == 0)
                  ? Yii::t('user', 'Never')
        ...
        [
            ...
            'buttons' => [
                'resend_password' => function ($url, $model, $key) {
                    return (Yii::$app->user->identity->isAdmin && !$model->isAdmin)
                ...
                'switch' => function ($url, $model) {
                    return (Yii::$app->user->identity->isAdmin && $model->id != Yii::$app->user->id && Yii::$app->getModule('user')->enableImpersonateUser)
