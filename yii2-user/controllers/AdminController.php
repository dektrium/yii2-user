...
class AdminController extends Controller
{
    ...
    /**
     * If "ddmtechdev/yii2-rbac" extension is installed, this page displays form
    ...
    {
        if (!isset(\Yii::$app->extensions['ddmtechdev/yii2-rbac'])) {
